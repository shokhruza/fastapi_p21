...
async def get_all_products(request: Request, category: int = None, search: str = None):
    ...
    return templates.TemplateResponse(request, 'apps/product/product-list.html', context)
...
async def get_product(request: Request, slug: str):
    ...
    return templates.TemplateResponse(request, 'apps/product/product-detail.html', context)
